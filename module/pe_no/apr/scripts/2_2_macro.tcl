...
set inst_w [expr [dbGet [dbGetCellByName TS1N28HPCPUHDHVTB32X64M1SSO].size_x]]
set inst_h [expr [dbGet [dbGetCellByName TS1N28HPCPUHDHVTB32X64M1SSO].size_y]]
...
placeInstance fpu_config_inst/FUs_instance/dmem_gen_1__dmem_unit/mem/mem2 [expr $start_x + $dmem_w + 2*$t_pitch] $start_y -fixed
placeInstance fpu_config_inst/FUs_instance/dmem_gen_0__dmem_unit/mem/mem1 $start_x [expr $start_y + $dmem_h + 5] -fixed
placeInstance fpu_config_inst/FUs_instance/dmem_gen_0__dmem_unit/mem/mem2 [expr $start_x + $dmem_w + 2*$t_pitch] [expr $start_y + $dmem_h + 5] -fixed
...
placeInstance imem_inst/mem/mem2 $start_x [expr $start_y + 1*$inst_h + 10] MY -fixed
