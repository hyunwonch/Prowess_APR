...
set layer_type  [getenv DESIGN_NAME]
set layer_name  [getenv DESIGN_NAME]
set top_level   ${layer_name}

# Directory Names
set CURRENT_PATH [pwd]
set TSMC28_dir  /net/badwater/z/hyunwon/Documents/TSMC_Prowess/tsmc28
set VC_dir      /net/badwater/z/hyunwon/Documents/TSMC_Prowess/tsmc28/module/${layer_name}
set tech_dir    ${TSMC28_dir}/techfile
set lib_dir     ${TSMC28_dir}/lib
set lef_dir     ${TSMC28_dir}/lef
set mem_dir     ${TSMC28_dir}/mem/lef
set innovus_dir ${TSMC28_dir}/innovus/N28
