...
if {![catch {selectInstByCellName TS1N28HPCPUHDHVTB128X64M2SSO}]} {
...
if {![catch {selectInstByCellName TS1N28HPCPUHDHVTB128X256M1SSO}]} {
    addStripe -nets "VSS VDD" \
            -layer M7 \
            -direction vertical \
            -width $stripe_w -spacing $stripe_s \
...
# 				-layer M2                                           \
# 				-direction horizontal                               \
# 				-width $M2_stripe_width                             \
# 				-spacing [expr $M2_stripe_pitch - $M2_stripe_width] \
# 				-set_to_set_distance [expr $M2_stripe_pitch * 2]    \
# 				-start_offset [expr 0 - $M2_stripe_width / 2]       \
# 				-stop_offset [expr 0 - $M2_stripe_width]
