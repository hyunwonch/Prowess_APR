...
for {set idx 0} {$idx < 5} {incr idx} {
    set x [expr 300 + $idx * ($INST_MEM_w + 10)]
    placeInstance pl/inst_mem/cache_inst/mem_bank_gen_${idx}__mem_i $x 1840
}

for {set idx 0} {$idx < 4} {incr idx} {
    set x [expr 700 + $idx * ($CMD_MEM_w + 10)]
    placeInstance pl/cmd_mem/cmd_inst/mem_bank_gen_${idx}__mem_i $x 1750
}
