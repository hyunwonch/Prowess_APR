...
create_delay_corner -name maxDelay -library_set {svtMaxLib sramMaxLib} -rc_corner maxRC
create_delay_corner -name minDelay -library_set {svtMinLib sramMinLib} -rc_corner minRC
