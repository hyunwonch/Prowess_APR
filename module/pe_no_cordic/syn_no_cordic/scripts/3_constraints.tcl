...
remove_input_delay [get_ports pe_config_in*]
remove_output_delay [get_ports pe_config_out*]

set_input_delay 0.3  -clock $clk_name [get_ports pe_config_in*]
set_output_delay 0.3 -clock $clk_name [get_ports pe_config_out*]
