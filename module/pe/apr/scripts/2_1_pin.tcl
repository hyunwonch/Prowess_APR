...
set config2 [expr $clk - 50]


#TOP
editPin -pin data_i_1* -pinWidth 0.05 -fixedpin 1 -layer M5 -snap TRACK -side TOP -spreadType START -start $x_pos0 $y_size -spacing 0.6
...
editPin -pin pe_interrupt_o* -fixedpin 1 -layer M5 -snap TRACK -side TOP -spreadType START -start $config2 $y_size -spacing 0.6
...
editPin -pin pe_interrupt_i* -fixedpin 1 -layer M5 -snap TRACK -side BOTTOM -spreadType START -start $config2 0.0 -spacing 0.6 -spreadDirection counterclockwise
