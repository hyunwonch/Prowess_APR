...
set VERILOG_PATH [getenv VERILOG_PATH]
...
###
###################################
source -echo -verbose $SCRIPTS_PATH/0_suppress_dc.tcl
...
###
###################################
compile_ultra -no_boundary_optimization -no_seq_output_inversion -no_autoungroup -gate_clock
...
write_sdf -v 3.0 -context verilog "${OUTPUT_PATH}/${DESIGN_NAME}.dc.sdf"
