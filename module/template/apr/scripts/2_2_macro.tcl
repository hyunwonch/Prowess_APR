...
for {set row 0} {$row < $num_dma} {incr row} {
    ...
    # Calculate x and y coordinates
    set x 15
    set y [expr 10 + (8-$row)*(10+266.8)]  ;# Y-axis flips (top to bottom)

    # Generate instance name
    set instance_name "pe_array/u_dma_left/mem_banks_${row}__mem_inst"
...
for {set row 0} {$row < $num_dma} {incr row} {
    ...
    # Generate instance name
    set instance_name "pe_array/u_dma_right/mem_banks_${row}__mem_inst"
