...
set_false_path -through [get_nets -hier *sd*]
set_false_path -through [get_nets -hier *slp*]
set_false_path -from -setup [get_ports -filter "direction == in" "rst*"]
set_false_path -from -hold  [get_ports -filter "direction == in" "rst*"]
set_false_path -through [get_nets -hier fpu_config_inst/FUs_instance/dmem_gen_0__dmem_unit/*slp*]
set_false_path -through [get_nets -hier fpu_config_inst/FUs_instance/dmem_gen_0__dmem_unit/*sd*]
set_false_path -through [get_nets -hier fpu_config_inst/FUs_instance/dmem_gen_1__dmem_unit/*slp*]
set_false_path -through [get_nets -hier fpu_config_inst/FUs_instance/dmem_gen_1__dmem_unit/*sd*]

# set_false_path -through [get_nets -hier *ret1n*]
