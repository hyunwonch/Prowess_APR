...
set lef_file        [list \
    ...
    ${mem_dir}/ts1n28hpcpuhdlvtb512x64m4sso_170a.lef  \
    ${mem_dir}/ts1n28hpcpuhdlvtb512x128m4sso_170a.lef  \
    ${mem_dir}/ts1n28hpcpuhdlvtb2048x64m4sso_170a.lef  \
    ${mem_dir}/ts1n28hpcpuhdlvtb2048x32m4sso_170a.lef  \
    ${hier_dir}/PE_prowess.lef  \
]
...
set typ_sram_lib_file [glob -nocomplain  -directory /afs/eecs.umich.edu/vlsida/projects/PROWESS/tsmc28_2/mem/lib *.lib]

set max_sram_lib_file [glob -nocomplain  -directory /afs/eecs.umich.edu/vlsida/projects/PROWESS/tsmc28_2/mem/lib *.lib]

set min_sram_lib_file [glob -nocomplain  -directory /afs/eecs.umich.edu/vlsida/projects/PROWESS/tsmc28_2/mem/lib *.lib]
