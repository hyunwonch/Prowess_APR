...
editPin -pin config_in* -pinWidth 0.05 -fixedpin 1 -layer M5 -snap TRACK -side TOP -spreadType START -start $config $y_size -spacing 0.6
editPin -pin scan* -pinWidth 0.05 -fixedpin 1 -layer M5 -snap TRACK -side TOP -spreadType START -start $scan $y_size -spacing 0.6
